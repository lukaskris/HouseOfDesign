...
import com.leaksoft.app.houseofdesign.transaction.ConfirmationActivity;
...
public class ShoppingCartFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.shopping_cart_recyclerview);
        ShoppingCartAdapter adapter = new ShoppingCartAdapter(getContext(), mCarts);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(adapter);

        Button mConfirm = (Button) view.findViewById(R.id.shopping_cart_confirm);
